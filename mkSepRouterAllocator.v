...
//
// On Tue Jul 29 12:30:57 PDT 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkSepRouterAllocator(pipeline,
  ...
  // register as_inputArbGrants_reg_3_0
  reg as_inputArbGrants_reg_3_0;
  wire as_inputArbGrants_reg_3_0$D_IN, as_inputArbGrants_reg_3_0$EN;
  ...
  // register as_inputArbGrants_reg_4_0
  reg as_inputArbGrants_reg_4_0;
  wire as_inputArbGrants_reg_4_0$D_IN, as_inputArbGrants_reg_4_0$EN;
  ...
  // register as_inputArbGrants_reg_3_0
  assign as_inputArbGrants_reg_3_0$D_IN = inputArbs$input_arbs_3_select[0] ;
  assign as_inputArbGrants_reg_3_0$EN = EN_allocate && pipeline ;
  ...
  // register as_inputArbGrants_reg_4_0
  assign as_inputArbGrants_reg_4_0$D_IN = inputArbs$input_arbs_4_select[0] ;
  assign as_inputArbGrants_reg_4_0$EN = EN_allocate && pipeline ;
  ...
  assign outputArbs$output_arbs_0_select_requests =
	     pipeline ?
	       { as_inputArbGrants_reg_4_0,
		 as_inputArbGrants_reg_3_0,
  ...
  begin
	...
	as_inputArbGrants_reg_3_0 <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	as_inputArbGrants_reg_4_0 <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (as_inputArbGrants_reg_3_0$EN)
	  as_inputArbGrants_reg_3_0 <= `BSV_ASSIGNMENT_DELAY
	      as_inputArbGrants_reg_3_0$D_IN;
	...
	if (as_inputArbGrants_reg_4_0$EN)
	  as_inputArbGrants_reg_4_0 <= `BSV_ASSIGNMENT_DELAY
	      as_inputArbGrants_reg_4_0$D_IN;
